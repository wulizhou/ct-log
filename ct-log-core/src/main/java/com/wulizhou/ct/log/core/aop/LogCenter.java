package com.wulizhou.ct.log.core.aop;

import com.wulizhou.ct.log.core.annotation.Log;
...
import com.wulizhou.ct.log.core.util.CollectionUtil;
import com.wulizhou.ct.log.core.util.ObjectUtils;
import com.wulizhou.ct.log.core.util.WebUtil;
...
public class LogCenter {
	 ...
	 * 排除用户自定义不进行操作记录的类或方法
	 */
	@Pointcut("!(@within(com.wulizhou.ct.log.core.annotation.IgnoreLog) || @annotation(com.wulizhou.ct.log.core.annotation.IgnoreLog))")
	public void needLog(){}
